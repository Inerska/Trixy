...
namespace Trixy.Bot.Helpers
{
    internal static class TemplateEmbed
    {
        ...
        internal static async Task<Embed> GetAboutMeEmbed(string botAvatarUrl, Snowflake botId)
        {
            ...
            builder.AppendLine($"Hello, I'm {botId.Mention()}, the bot will make your discord server in a new era of __modernity__");
            builder.AppendLine("I dont have any prefix as my peers, you can access my commands with `/`, cool right ?\n");
            builder.AppendLine("I'm open-source, you can contribute and raise an issue (even a typo) in my [GitHub repository](https://github.com/Inerska/Trixy)");
